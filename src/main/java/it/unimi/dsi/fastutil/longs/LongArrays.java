...
public class LongArrays {
	 ...
	 * @return <code>a</code>.
	 */
	public static long[] shuffle(final long[] a, final int from, final int to, final EaglercraftRandom random) {
	 ...
	 * @return <code>a</code>.
	 */
	public static long[] shuffle(final long[] a, final EaglercraftRandom random) {
