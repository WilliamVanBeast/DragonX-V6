...
public class ObjectArrayFIFOQueue<K> extends AbstractPriorityQueue<K> {
	...
	public K array[] = (K[]) ObjectArrays.EMPTY_ARRAY;
	...
	public void clear() {
		...
		if (start <= end)
			ObjectArrays.fill(array, start, end, null);
		else {
	...
	public K get(int index) {
		...
		final int idx = (this.start + index) % this.array.length;
		return (K) this.array[idx];
	}
