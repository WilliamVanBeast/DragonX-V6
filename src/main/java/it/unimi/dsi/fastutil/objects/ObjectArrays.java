...
public class ObjectArrays {
	 ...
	 * @return <code>a</code>.
	 */
	public static <K> K[] shuffle(final K[] a, final int from, final int to, final EaglercraftRandom random) {
	 ...
	 * @return <code>a</code>.
	 */
	public static <K> K[] shuffle(final K[] a, final EaglercraftRandom random) {
