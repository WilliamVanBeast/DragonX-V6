...
public class ByteArrays {
	 ...
	 * @return <code>a</code>.
	 */
	public static byte[] shuffle(final byte[] a, final int from, final int to, final EaglercraftRandom random) {
	 ...
	 * @return <code>a</code>.
	 */
	public static byte[] shuffle(final byte[] a, final EaglercraftRandom random) {
