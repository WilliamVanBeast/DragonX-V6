...
public class DoubleArrays {
	 ...
	 * @return <code>a</code>.
	 */
	public static double[] shuffle(final double[] a, final int from, final int to, final EaglercraftRandom random) {
	 ...
	 * @return <code>a</code>.
	 */
	public static double[] shuffle(final double[] a, final EaglercraftRandom random) {
