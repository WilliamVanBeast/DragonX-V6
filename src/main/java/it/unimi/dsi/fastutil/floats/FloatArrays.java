...
public class FloatArrays {
	 ...
	 * @return <code>a</code>.
	 */
	public static float[] shuffle(final float[] a, final int from, final int to, final EaglercraftRandom random) {
	 ...
	 * @return <code>a</code>.
	 */
	public static float[] shuffle(final float[] a, final EaglercraftRandom random) {
