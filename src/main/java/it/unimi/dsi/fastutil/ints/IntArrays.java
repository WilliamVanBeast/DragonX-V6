...
public class IntArrays {
	 ...
	 * @return <code>a</code>.
	 */
	public static int[] shuffle(final int[] a, final int from, final int to, final EaglercraftRandom random) {
	 ...
	 * @return <code>a</code>.
	 */
	public static int[] shuffle(final int[] a, final EaglercraftRandom random) {
