...
public class BooleanArrays {
	 ...
	 * @return <code>a</code>.
	 */
	public static boolean[] shuffle(final boolean[] a, final int from, final int to, final EaglercraftRandom random) {
	 ...
	 * @return <code>a</code>.
	 */
	public static boolean[] shuffle(final boolean[] a, final EaglercraftRandom random) {
