package dragonclient.cosmetic.impl;
...
import dragonclient.cosmetic.CosmeticBase;
import dragonclient.cosmetic.CosmeticController;
...
public class CosmeticBlaze extends CosmeticBase
{
    ...
    private static final ResourceLocation blazeTextures = new ResourceLocation("dragonx/blaze.png");
    ...
    {
             if (CosmeticController.renderBlaze(player)) {
    ...
    private class BlazeModel extends CosmeticModelBase
    {
