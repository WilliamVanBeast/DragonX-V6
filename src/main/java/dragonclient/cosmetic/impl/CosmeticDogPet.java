...
public class CosmeticDogPet extends CosmeticBase {
  ...
  public static final ResourceLocation TEXTURE = new ResourceLocation("dragonx/wolfModel.png");
  ...
  public void render(AbstractClientPlayer player, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
    ...
    if (CosmeticController.renderDogPet(player)) {
  ...
  class WolfModel extends CosmeticModelBase {
