package dragonclient.util.notifications;
...
public class Notification {
    ...
    public void render() {
        ...
        RenderUtil.drawRoundedRect(xVisual-10, yVisual-8, sr.getScaledWidth(), yVisual+25, 4, new Color(0, 0, 0, 170).getRGB());

        RenderUtil.drawRect(xVisual-10 + (percentageLeft * (Minecraft.getMinecraft().fontRendererObj.getStringWidth(description)) + 8), yVisual + 20, screenWidth + 1, yVisual + 22, c.getRGB());
