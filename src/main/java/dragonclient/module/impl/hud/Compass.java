...
public class Compass extends RenderModule {
    public Compass() {
        super("Compass", Category.HUD, 10, 10, 102, 15);
    }
    ...
    @Override
    public void draw() {
        int direction = MathHelper.floor((double) (mc.player.rotationYaw * 256.0F / 360.0F) + 0.5D) & 255;
        int yBase = 12;
        int xBase = 65;
        
        mc.getTextureManager().bindTexture(new ResourceLocation("dragonx/compass.png"));
        if (direction < 128) {
