...
public class Penis extends Module{
    private BooleanSetting animation = new BooleanSetting("Animation", true);
    public Penis() {
   ...
   public void onRender3DEvent(final Render3DEvent event) {
            ...
            if (o instanceof EntityOtherPlayerMP) {
                ...
                final double n = player.lastTickPosX + (player.posX - player.lastTickPosX) * mc.timer.field_194148_c;
                Minecraft.getMinecraft().getRenderManager();
                final double x = n - Minecraft.getMinecraft().getRenderManager().renderPosX;
                final double n2 = player.lastTickPosY + (player.posY - player.lastTickPosY) * mc.timer.field_194148_c;
                mc.getRenderManager();
                final double y = n2 - Minecraft.getMinecraft().getRenderManager().renderPosY;
                final double n3 = player.lastTickPosZ + (player.posZ - player.lastTickPosZ) * mc.timer.field_194148_c;
                mc.getRenderManager();
