...
import net.shadow.client.util.JDKUtils;
...
public class GlyphSubstitutionTable extends TTFTable
{
     ...
     */
    private static final Predicate<String> IS_4_CHAR_WORD = JDKUtils.asMatchPredicate(Pattern.compile("\\w{4}"));
    ...
    private Collection<LangSysTable> getLangSysTables(String scriptTag)
    {
        ...
        if (scriptTable != null)
        {
            ...
            {
                result = new ObjectArrayList<>(scriptTable.getLangSysTables().values());
            ...
            final List<String> enabledFeatures)
    {
        ...
        List<FeatureRecord> result = new ObjectArrayList<>();
