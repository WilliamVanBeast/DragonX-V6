 ...
 * <a href="https://docs.microsoft.com/en-us/typography/opentype/spec/gsub">GSUB
 * — Glyph Substitution Table</a> system of tables in the Open Type Font specs.
 * This is a part of the <a href=
 * "https://docs.microsoft.com/en-us/typography/opentype/spec/gsub#lookuptype-1-single-substitution-subtable">LookupType
 * 1: Single Substitution Subtable</a>. It specifically models the <a href=
 * "https://docs.microsoft.com/en-us/typography/opentype/spec/gsub#12-single-substitution-format-2">Single
...
public class LookupTypeSingleSubstFormat2 extends LookupSubTable {
	...
	public String toString() {
		return HString.format("LookupTypeSingleSubstFormat2[substFormat=%d,substituteGlyphIDs=%s]", getSubstFormat(),
				Arrays.toString(substituteGlyphIDs));
	}
}