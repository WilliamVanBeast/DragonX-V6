 ...
 * "https://docs.microsoft.com/en-us/typography/opentype/spec/gsub#11-single-substitution-format-1">Single
...
public class LookupTypeSingleSubstFormat1 extends LookupSubTable {
	...
	public String toString() {
		return HString.format("LookupTypeSingleSubstFormat1[substFormat=%d,deltaGlyphID=%d]", getSubstFormat(),
				deltaGlyphID);
	}
}
