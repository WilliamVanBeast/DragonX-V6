 ...
 * "https://docs.microsoft.com/en-us/typography/opentype/spec/languagetags">Language
...
public class LangSysTable {
	...
	public String toString() {
		return HString.format("LangSysTable[requiredFeatureIndex=%d]", requiredFeatureIndex);
	}
}
