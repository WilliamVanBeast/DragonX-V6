 ...
 * "https://docs.microsoft.com/en-us/typography/opentype/spec/chapter2#coverage-format-2">Range
 * Record in the Coverage format 2</a> in the Open Type layout common tables.
 * 
 * @author Palash Ray
 *
 */
public class RangeRecord {
	...
	public String toString() {
		return HString.format("RangeRecord[startGlyphID=%d,endGlyphID=%d,startCoverageIndex=%d]", startGlyphID,
