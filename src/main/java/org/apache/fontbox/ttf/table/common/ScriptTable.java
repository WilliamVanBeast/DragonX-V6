 ...
 * "https://docs.microsoft.com/en-us/typography/opentype/spec/scripttags">Script
 * tags</a> in the Open Type Font specs.
 * 
 * @author Palash Ray
 *
 */
public class ScriptTable {
	...
	public String toString() {
		return HString.format("ScriptTable[hasDefault=%s,langSysRecordsCount=%d]", defaultLangSysTable != null,
				langSysTables.size());
	}
}