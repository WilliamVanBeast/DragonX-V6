 ...
 * "https://docs.microsoft.com/en-us/typography/opentype/spec/chapter2#feature-table">Feature
...
public class FeatureTable {
	...
	public String toString() {
		return HString.format("FeatureTable[lookupListIndicesCount=%d]", lookupListIndices.length);
	}
}
