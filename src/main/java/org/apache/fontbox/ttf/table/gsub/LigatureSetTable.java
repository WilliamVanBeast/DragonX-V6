 ...
 * "https://docs.microsoft.com/en-us/typography/opentype/spec/gsub#41-ligature-substitution-format-1">LigatureSet
 * table: All ligatures beginning with the same glyph</a>.
 * 
 * @author Palash Ray
 *
 */
public class LigatureSetTable {
	...
	public String toString() {
		return HString.format("%s[ligatureCount=%d]", LigatureSetTable.class.getSimpleName(), ligatureCount);
	}
}
