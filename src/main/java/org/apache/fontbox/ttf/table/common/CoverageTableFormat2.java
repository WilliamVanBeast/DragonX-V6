...
/**
 * This class models the <a href=
 * "https://docs.microsoft.com/en-us/typography/opentype/spec/chapter2#coverage-format-2">Coverage
 * format 2</a> in the Open Type layout common tables.
 * 
 * @author Palash Ray
 *
 */
public class CoverageTableFormat2 extends CoverageTableFormat1 {
	...
	private static int[] getRangeRecordsAsArray(RangeRecord[] rangeRecords) {
		List<Integer> glyphIds = new ObjectArrayList<>();
	...
	public String toString() {
		return HString.format("CoverageTableFormat2[coverageFormat=%d]", getCoverageFormat());
	}
}
