...
public class GsubWorkerForTamil implements GsubWorker {
	private static final Logger LOG = LogManager.getLogger("GsubWorkerForTamil");
	 ...
	 */
	private static final List<String> FEATURES_IN_ORDER = Arrays.asList("locl", "nukt", "akhn", "rphf", "pref", "half",
