 ...
 * XMLGraphics. See <a href="http://xmlgraphics.apache.org/batik/">The Apache™
 * Batik Project</a> for further details.
 */
public class GlyfCompositeDescript extends GlyfDescript {
	/**
	 * Log instance.
	 */
	private static final Logger LOG = LogManager.getLogger("GlyfCompositeDescript");

	private final List<GlyfCompositeComp> components = new ObjectArrayList<>();
	 ...
	 * 
	 * @return unmodifiable list of this composite glyph's
	 *         {@linkplain GlyfCompositeComp components}
	 */
