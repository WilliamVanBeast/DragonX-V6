...
public class CFFParser
{
     ...
     * Log instance.
     */
    private static final Logger LOG = LogManager.getLogger("CFFParser");
    ...
    private List<CFFFont> parse(DataInput input) throws IOException
    {
        ...
        List<CFFFont> fonts = new ObjectArrayList<>(nameIndex.length);
            ...
            throws IOException
    {
        ...
        for (byte[] bytes : fdIndex)
        {
            ...
            if (privateEntry == null || privateEntry.size() < 2)
            {
                ...
                privateDictionaries.add(new Object2ObjectOpenHashMap<>());
                continue;
            }
    ...
    private static class DictData
    {
        ...
        {
            private final List<Number> operands = new ObjectArrayList<>();
            ...
            {
                List<Number> result = new ObjectArrayList<>(operands);
    ...
    private static class Format1Charset extends EmbeddedCharset
    {
        ...
        {
            super(isCIDFont);
            rangesCID2GID = new ObjectArrayList<>();
        }
