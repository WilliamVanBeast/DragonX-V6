...
public class CIDKeyedType2CharString extends Type2CharString {
	 ...
	 */
	public CIDKeyedType2CharString(Type1CharStringReader font, String fontName, int cid, int gid, List<Object> sequence,
			int defaultWidthX, int nomWidthX) {
		// glyph name is for debugging only
		super(font, fontName, HString.format("%04x", cid), gid, sequence, defaultWidthX, nomWidthX);
		this.cid = cid;
	}
