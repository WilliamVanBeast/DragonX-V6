...
public class CFFType1Font extends CFFFont implements EncodedFont {
	...
	private final Int2ObjectMap<Type2CharString> charStringCache = new Int2ObjectOpenHashMap<>();
	...
	private Type2CharString getType2CharString(int gid, String name) throws IOException {
		...
		if (type2 == null) {
			...
			type2 = new Type2CharString(reader, getName(), name, gid, type2seq, getDefaultWidthX(), getNominalWidthX());
