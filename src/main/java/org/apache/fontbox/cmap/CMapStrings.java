...
{
    private static final List<String> twoByteMappings = new ObjectArrayList<>(256 * 256);
    private static final List<String> oneByteMappings = new ObjectArrayList<>(256);

    private static final List<Integer> indexValues = new ObjectArrayList<>(256 * 256);
    private static final List<byte[]> oneByteValues = new ObjectArrayList<>(256);
    private static final List<byte[]> twoByteValues = new ObjectArrayList<>(256 * 256);
