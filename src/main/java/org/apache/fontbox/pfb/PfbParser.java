...
//
//	/**
//	 * the pfb header length. (start-marker (1 byte), ascii-/binary-marker (1 byte),
//	 * size (4 byte)) 3*6 == 18
//	 */
...
//		EaglerInputStream in = new EaglerInputStream(pfb);
//		long total = 0;
//		do {
//			int r = in.read();
//			if (r == -1 && total > 0) {
...
//		} while (true);
//
//		// We now have ASCII and binary segments. Lets arrange these so that the ASCII
//		// segments
...
//		return new EaglerInputStream(pfbdata);
//	}
//
//	/**
