...
public class FontMetrics
{
    ...
    private final List<String> comments = new ObjectArrayList<>();
    ...
    private final List<CharMetric> charMetrics = new ObjectArrayList<>();
    private final Object2ObjectMap<String, CharMetric> charMetricsMap = new Object2ObjectOpenHashMap<>();
    private final List<TrackKern> trackKern = new ObjectArrayList<>();
    private final List<Composite> composites = new ObjectArrayList<>();
    private final List<KernPair> kernPairs = new ObjectArrayList<>();
    private final List<KernPair> kernPairs0 = new ObjectArrayList<>();
    private final List<KernPair> kernPairs1 = new ObjectArrayList<>();
