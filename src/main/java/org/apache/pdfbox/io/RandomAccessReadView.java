...
/**
 * This class provides a view of a part of a random access read. It clips the
 * section starting at the given start position with the given length into a new
 * random access read.
 * 
 */
public class RandomAccessReadView implements RandomAccessRead {
	 ...
	 * @param startPosition    start position within the underlying random access
	 *                         read
	 ...
	 *                         read
	 * @param streamLength     stream length
	 * @param closeInput       close the underlying random access read when closing
	 *                         the view if set to true
	 */
	public RandomAccessReadView(RandomAccessRead randomAccessRead, long startPosition, long streamLength,
			boolean closeInput) {
