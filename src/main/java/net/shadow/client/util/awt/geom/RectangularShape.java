...
public abstract class RectangularShape implements Shape, Cloneable {
	...
	/**
	 * Sets the location and size of the framing rectangle of this
	 * <code>Shape</code> to the specified {@link Point2D} and {@link Dimension2D},
	...
	/**
	 * Sets the diagonal of the framing rectangle of this <code>Shape</code> based
	 * on the two specified coordinates. The framing rectangle is used by the
	...
	/**
	 * Sets the diagonal of the framing rectangle of this <code>Shape</code> based
	 * on two specified <code>Point2D</code> objects. The framing rectangle is used
	 * by the subclasses of <code>RectangularShape</code> to define their geometry.
	 *
	...
	/**
	 * Sets the framing rectangle of this <code>Shape</code> based on the specified
	 * center point coordinates and corner point coordinates. The framing rectangle
	 * is used by the subclasses of <code>RectangularShape</code> to define their
	 * geometry.
	 *
	...
	/**
	 * Sets the framing rectangle of this <code>Shape</code> based on a specified
	 * center <code>Point2D</code> and corner <code>Point2D</code>. The framing
	 ...
	 * object's boundary and provides access to a flattened view of the outline of
	 * the <code>Shape</code> object's geometry.
	 * <p>
	 * Only SEG_MOVETO, SEG_LINETO, and SEG_CLOSE point types will be returned by
	 * the iterator.
	 * <p>
	 ...
	 * flattened path segments. An optional {@link AffineTransform} can be specified
	 * so that the coordinates returned in the iteration are transformed
	 * accordingly.
	 * 
