...
public class Point extends Point2D implements java.io.Serializable {
	...
	/**
	 * Constructs and initializes a point at the specified {@code (x,y)} location in
	 ...
	 * to parallel the <code>getLocation</code> method of <code>Component</code>.
	 * 
	 ...
	 * included for completeness, to parallel the <code>setLocation</code> method of
	 * <code>Component</code>.
	 * 
	 ...
	 * <code>setLocation</code> method of <code>Component</code>. Its behavior is
	 * identical with <code>move(int,&nbsp;int)</code>.
	 * 
	 ...
	 * <code>Integer.MIN_VALUE</code> will be reset to <code>MIN_VALUE</code>, and
	 * any number larger than <code>Integer.MAX_VALUE</code> will be reset to
	 * <code>MAX_VALUE</code>.
	 *
	 * @param x the X coordinate of the new location
	 * @param y the Y coordinate of the new location
	 ...
	 * plane. This method is identical with <code>setLocation(int,&nbsp;int)</code>.
	 * 
	 * @param x the X coordinate of the new location
	 * @param y the Y coordinate of the new location
	 * @see java.awt.Component#setLocation(int, int)
