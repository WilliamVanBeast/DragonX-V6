...
public abstract class Ellipse2D extends RectangularShape {
	...
	public static class Float extends Ellipse2D implements Serializable {
		...
		/**
		 * Constructs a new <code>Ellipse2D</code>, initialized to location (0,&nbsp;0)
		 * and size (0,&nbsp;0).
		 * 
		 * @since 1.2
		 */
		...
		/**
		 * Constructs and initializes an <code>Ellipse2D</code> from the specified
		 * coordinates.
		 *
	 ...
	 * <code>Ellipse2D</code>. The iterator for this class is multi-threaded safe,
	 * which means that this <code>Ellipse2D</code> class guarantees that
	 * modifications to the geometry of this <code>Ellipse2D</code> object do not
	 ...
	 *         outline of this <code>Ellipse2D</code>, one segment at a time.
	 * @since 1.2
	 */
	 ...
	 * <code>Ellipse2D</code>. The specified <code>Object</code> is equal to this
	 * <code>Ellipse2D</code> if it is an instance of <code>Ellipse2D</code> and if
	 * its location and size are the same as this <code>Ellipse2D</code>.
	 * 
	 * @param obj an <code>Object</code> to be compared with this
	 *            <code>Ellipse2D</code>.
	 * @return <code>true</code> if <code>obj</code> is an instance of
	 *         <code>Ellipse2D</code> and has the same values; <code>false</code>
	 *         otherwise.
	 * @since 1.6
	 */
