...
import net.shadow.client.util.awt.geom.Dimension2D;
...
public class Dimension extends Dimension2D implements java.io.Serializable {
	 ...
	 * same as for the specified dimension.
	 *
	...
	/**
	 * Constructs a <code>Dimension</code> and initializes it to the specified width
	...
	/**
	 * Sets the size of this <code>Dimension</code> object to the specified width
	 * and height in double precision. Note that if <code>width</code> or
	 * <code>height</code> are larger than <code>Integer.MAX_VALUE</code>, they will
	...
	/**
	 * Gets the size of this <code>Dimension</code> object. This method is included
	 * for completeness, to parallel the <code>getSize</code> method defined by
	 * <code>Component</code>.
	 *
	 * @return the size of this dimension, a new instance of <code>Dimension</code>
	...
	/**
	 * Sets the size of this <code>Dimension</code> object to the specified width
	 * and height. This method is included for completeness, to parallel the
	 * <code>setSize</code> method defined by <code>Component</code>.
	 *
