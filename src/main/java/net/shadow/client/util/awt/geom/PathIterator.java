...
public interface PathIterator {
	 ...
	 * <code>(t=[0..1])</code> using the most recently specified (current) point
	 * (CP), the first control point (P1), and the final interpolated control point
	 ...
	 * curve is interpolated by solving the parametric control equation in the range
	 * <code>(t=[0..1])</code> using the most recently specified (current) point
	 * (CP), the first control point (P1), the second control point (P2), and the
	 * final interpolated control point (P3). The parametric control equation for
	 * this curve is:
	 * 
	 * <pre>
	 ...
	 * passed in and can be used to store the coordinates of the point(s). Each
	 * point is stored as a pair of float x,y coordinates. SEG_MOVETO and SEG_LINETO
	 * types returns one point, SEG_QUADTO returns two points, SEG_CUBICTO returns 3
	 * points and SEG_CLOSE does not return any points.
	 * 
	 ...
	 * SEG_LINETO types returns one point, SEG_QUADTO returns two points,
