...
public final class GeneralPath extends Path2D.Float {
	...
	/**
	 * Constructs a new <code>GeneralPath</code> object with the specified winding
	...
	/**
	 * Constructs a new <code>GeneralPath</code> object with the specified winding
	 * rule and the specified initial capacity to store path coordinates. This
	 * number is an initial guess as to how many path segments will be added to the
	 * path, but the storage is expanded as needed to store whatever path segments
	 * are added.
	 *
	 * @param rule            the winding rule
	 ...
	 * this path are taken from the specified <code>Shape</code> object.
	 *
