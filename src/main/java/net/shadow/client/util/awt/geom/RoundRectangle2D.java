...
public abstract class RoundRectangle2D extends RectangularShape {
	...
	public static class Float extends RoundRectangle2D implements Serializable {
		...
		/**
		 * Constructs a new <code>RoundRectangle2D</code>, initialized to location
		 * (0.0,&nbsp;0.0), size (0.0,&nbsp;0.0), and corner arcs of radius 0.0.
		 * 
		 * @since 1.2
		 */
		public Float() {
		...
		/**
		 * Constructs and initializes a <code>RoundRectangle2D</code> from the specified
		 ...
		 *             <code>RoundRectangle2D</code>
		 * @param arcw the width of the arc to use to round off the corners of the newly
		 *             constructed <code>RoundRectangle2D</code>
		 * @param arch the height of the arc to use to round off the corners of the
		 *             newly constructed <code>RoundRectangle2D</code>
		 * @since 1.2
		 */
		 ...
		 * <code>RoundRectangle2D</code> to the specified <code>float</code> values.
		 *
	...
	/**
	 * The <code>Double</code> class defines a rectangle with rounded corners all
	 * specified in <code>double</code> coordinates.
	 * 
	 * @since 1.2
	 */
	...
	/**
	 * Sets the location, size, and corner radii of this
	 * <code>RoundRectangle2D</code> to the specified <code>double</code> values.
	 *
	 * @param x         the X coordinate to which to set the location of this
	 *                  <code>RoundRectangle2D</code>
	 * @param y         the Y coordinate to which to set the location of this
	 ...
	 * <code>RoundRectangle2D</code>. The iterator for this class is multi-threaded
	 * safe, which means that this <code>RoundRectangle2D</code> class guarantees
	 * that modifications to the geometry of this <code>RoundRectangle2D</code>
	 ...
	 *         outline of this <code>RoundRectangle2D</code>, one segment at a time.
	 * @since 1.2
	 */
	 ...
	 * <code>RoundRectangle2D</code>. The specified <code>Object</code> is equal to
	 * this <code>RoundRectangle2D</code> if it is an instance of
