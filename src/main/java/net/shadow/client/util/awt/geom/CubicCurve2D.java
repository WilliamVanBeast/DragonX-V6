...
public abstract class CubicCurve2D implements Shape, Cloneable {
	...
	public static class Float extends CubicCurve2D implements Serializable {
		 ...
		 *
		 * @param x1     the X coordinate for the start point of the resulting
		 *               {@code CubicCurve2D}
		 * @param y1     the Y coordinate for the start point of the resulting
		 *               {@code CubicCurve2D}
		 ...
		 *               {@code CubicCurve2D}
		 * @param x2     the X coordinate for the end point of the resulting
		 *               {@code CubicCurve2D}
		 * @param y2     the Y coordinate for the end point of the resulting
		 *               {@code CubicCurve2D}
		 * @since 1.2
		 */
		...
		/**
		 * Sets the location of the end points and control points of this curve to the
		 * specified {@code float} coordinates.
		 *
		 * @param x1     the X coordinate used to set the start point of this
		 *               {@code CubicCurve2D}
		 * @param y1     the Y coordinate used to set the start point of this
		 *               {@code CubicCurve2D}
		 ...
		 *               {@code CubicCurve2D}
		 * @param x2     the X coordinate used to set the end point of this
		 *               {@code CubicCurve2D}
		 * @param y2     the Y coordinate used to set the end point of this
		 *               {@code CubicCurve2D}
		 * @since 1.2
		 */
	 ...
	 * @param offset the index of <code>coords</code> from which to begin setting
	 ...
	 * 
	 * @param p1  the first specified <code>Point2D</code> used to set the start
	 *            point of this curve
	 * @param cp1 the second specified <code>Point2D</code> used to set the first
	 *            control point of this curve
	 * @param cp2 the third specified <code>Point2D</code> used to set the second
	 *            control point of this curve
	 * @param p2  the fourth specified <code>Point2D</code> used to set the end
	 *            point of this curve
	 * @since 1.2
	 */
	...
	/**
	 * Sets the location of the end points and control points of this curve to the
	 * coordinates of the <code>Point2D</code> objects at the specified offset in
	 * the specified array.
	 * 
	 * @param pts    an array of <code>Point2D</code> objects
	 * @param offset the index of <code>pts</code> from which to begin setting the
	 ...
	 * indicated control points. The flatness is the maximum distance of a control
	 * point from the line connecting the end points.
	 *
	 * @param x1     the X coordinate that specifies the start point of a
	 *               {@code CubicCurve2D}
	 * @param y1     the Y coordinate that specifies the start point of a
	 *               {@code CubicCurve2D}
	 * @param ctrlx1 the X coordinate that specifies the first control point of a
	 *               {@code CubicCurve2D}
	 * @param ctrly1 the Y coordinate that specifies the first control point of a
	 *               {@code CubicCurve2D}
	 ...
	 *               {@code CubicCurve2D}
	 * @param x2     the X coordinate that specifies the end point of a
	 *               {@code CubicCurve2D}
	 * @param y2     the Y coordinate that specifies the end point of a
	 *               {@code CubicCurve2D}
	 * @return the square of the flatness of the {@code CubicCurve2D} represented by
	...
	/**
	 * Returns the flatness of the cubic curve specified by the indicated control
	 * points. The flatness is the maximum distance of a control point from the line
	 ...
	 * @param y2     the Y coordinate that specifies the end point of a
	 *               {@code CubicCurve2D}
	 * @return the flatness of the {@code CubicCurve2D} represented by the specified
	 *         coordinates.
	 * @since 1.2
	 */
	 ...
	 * flatness is the maximum distance of a control point from the line connecting
	 * the end points.
	 * 
	 * @param coords an array containing coordinates
	 * @param offset the index of <code>coords</code> from which to begin getting
	 *               the end points and control points of the curve
	 * @return the square of the flatness of the <code>CubicCurve2D</code> specified
	 *         by the coordinates in <code>coords</code> at the specified offset.
	 * @since 1.2
	 */
	 ...
	 * maximum distance of a control point from the line connecting the end points.
	 * 
	 * @param coords an array containing coordinates
	 * @param offset the index of <code>coords</code> from which to begin getting
	 *               the end points and control points of the curve
	...
	/**
	 * Returns the square of the flatness of this curve. The flatness is the maximum
	 * distance of a control point from the line connecting the end points.
	 * 
	 ...
	 * 
	 * @param left  the cubic curve object for storing for the left or first half of
	 *              the subdivided curve
	 * @param right the cubic curve object for storing for the right or second half
	...
	/**
	 * Subdivides the cubic curve specified by the <code>src</code> parameter and
	 * stores the resulting two subdivided curves into the <code>left</code> and
	 * <code>right</code> curve parameters. Either or both of the <code>left</code>
	 * and <code>right</code> objects may be the same as the <code>src</code> object
	 * or <code>null</code>.
	 * 
	 * @param src   the cubic curve to be subdivided
	 * @param left  the cubic curve object for storing the left or first half of the
	 *              subdivided curve
	 * @param right the cubic curve object for storing the right or second half of
	 *              the subdivided curve
	 * @since 1.2
	 */
	 ...
	 * (<code>srcoff</code>&nbsp;+&nbsp;7) and stores the resulting two subdivided
	 * curves into the two result arrays at the corresponding indices. Either or
	 * both of the <code>left</code> and <code>right</code> arrays may be
	 * <code>null</code> or a reference to the same array as the <code>src</code>
	 * array. Note that the last point in the first subdivided curve is the same as
	 * the first point in the second subdivided curve. Thus, it is possible to pass
	 * the same array for <code>left</code> and <code>right</code> and to use
	 * offsets, such as <code>rightoff</code> equals (<code>leftoff</code> + 6), in
	 * order to avoid allocating extra storage for this common point.
	 * 
	 ...
	 * of roots. The solved cubic is represented by the equation:
	 * 
	 * <pre>
	 *     eqn = {c, b, a, d}
	 *     dx^3 + ax^2 + bx + c = 0
	 * </pre>
	 * 
	 * A return value of -1 is used to distinguish a constant equation that might be
	 ...
	 * place the non-complex roots into the <code>res</code> array, returning the
	 * number of roots. The cubic solved is represented by the equation: eqn = {c,
	 * b, a, d} dx^3 + ax^2 + bx + c = 0 A return value of -1 is used to distinguish
	 * a constant equation, which may be always 0 or never 0, from an equation which
	 * has no zeroes.
	 * 
	 * @param eqn the specified array of coefficients to use to solve the cubic
	 *            equation
	 ...
	 * http://en.wikipedia.org/wiki/Sturm%27s_theorem#Applications. The above link
	 * doesn't contain a proof, but I [dlila] proved it myself so the result is
	 * reliable. The proof isn't difficult, but it's a bit long to include here.
	 ...
	 * <code>CubicCurve2D</code> class does not guarantee that modifications to the
	 * geometry of this <code>CubicCurve2D</code> object do not affect any
	 * iterations of that geometry that are already in process.
	 * 
	 * @param at an optional <code>AffineTransform</code> to be applied to the
	 *           coordinates as they are returned in the iteration, or
	 *           <code>null</code> if untransformed coordinates are desired
	 * @return the <code>PathIterator</code> object that returns the geometry of the
	 *         outline of this <code>CubicCurve2D</code>, one segment at a time.
	 * @since 1.2
	 */
