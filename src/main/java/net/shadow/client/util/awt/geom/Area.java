...
import net.shadow.client.util.sun.awt.geom.Crossings;
import net.shadow.client.util.sun.awt.geom.AreaOp;
...
public class Area implements Shape, Cloneable {
	 ...
	 * <code>Shape</code> is not already closed. The fill rule (even-odd or winding)
	 * specified by the geometry of the <code>Shape</code> is used to determine the
	 ...
	 * <code>Area</code>. The resulting shape of this <code>Area</code> will include
	 * the union of both shapes, or all areas that were contained in either this or
	 * the specified <code>Area</code>.
	 * 
	 * <pre>
	 *     // Example:
	...
	/**
	 * Subtracts the shape of the specified <code>Area</code> from the shape of this
	 * <code>Area</code>. The resulting shape of this <code>Area</code> will include
	 * areas that were contained only in this <code>Area</code> and not in the
	 * specified <code>Area</code>.
	 * 
	 * <pre>
	 *     // Example:
	 *     Area a1 = new Area([triangle 0,0 =&gt; 8,0 =&gt; 0,8]);
	...
	/**
	 * Sets the shape of this <code>Area</code> to the intersection of its current
	 * shape and the shape of the specified <code>Area</code>. The resulting shape
	 * of this <code>Area</code> will include only areas that were contained in both
	 * this <code>Area</code> and also in the specified <code>Area</code>.
	 * 
	 * <pre>
	 *     // Example:
	 *     Area a1 = new Area([triangle 0,0 =&gt; 8,0 =&gt; 0,8]);
	 ...
	 * current shape and the shape of the specified <code>Area</code>, minus their
	 * intersection. The resulting shape of this <code>Area</code> will include only
	 * areas that were contained in either this <code>Area</code> or in the
	 * specified <code>Area</code>, but not in both.
	 * 
	 * <pre>
	 *     // Example:
	 *     Area a1 = new Area([triangle 0,0 =&gt; 8,0 =&gt; 0,8]);
	...
	/**
	 * Removes all of the geometry from this <code>Area</code> and restores it to an
	 * empty area.
	 * 
	 * @since 1.2
	 */
	 ...
	 * polygonal geometry.
	 * 
	 * @return <code>true</code> if the geometry of this <code>Area</code> consists
	 *         entirely of line segments; <code>false</code> otherwise.
	 * @since 1.2
	 */
	 ...
	 * This method returns <code>true</code> if the path contains 0 or 1 subpaths,
	 * or <code>false</code> if the path contains more than 1 subpath. The subpaths
	 * are counted by the number of {@link PathIterator#SEG_MOVETO SEG_MOVETO}
	 * segments that appear in the path.
	 * 
	 * @return <code>true</code> if the <code>Area</code> is comprised of a single
	 ...
	 * the Shape. The bounding box will not be padded to include the control points
	 * of curves in the outline of the Shape, but should tightly fit the actual
	 * geometry of the outline itself.
	 * 
	 ...
	 * the Shape. The bounding box will not be padded to include the control points
	 * of curves in the outline of the Shape, but should tightly fit the actual
	 * geometry of the outline itself. Since the returned object represents the
	 * bounding box with integers, the bounding box can only be as tight as the
	 ...
	 * @return <code>true</code> if the two geometries are equal; <code>false</code>
	 *         otherwise.
	 * @since 1.2
	 */
	 ...
	 *         outline of this <code>Area</code>, one segment at a time.
	 * @since 1.2
	 */
