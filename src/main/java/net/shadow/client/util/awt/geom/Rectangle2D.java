...
public abstract class Rectangle2D extends RectangularShape {
	...
	public static class Float extends Rectangle2D implements Serializable {
		...
		/**
		 * Constructs and initializes a <code>Rectangle2D</code> from the specified
		 ...
		 *
		 * @param x the X coordinate of the upper-left corner of this
		 *          <code>Rectangle2D</code>
		 * @param y the Y coordinate of the upper-left corner of this
		 *          <code>Rectangle2D</code>
		...
		public int outcode(double x, double y) {
			 ...
			 * float, then some bits may be lost if the binary exponents of x/y and w/h are
			 * not similar. By converting to double before the addition we force the
			 * addition to be carried out in double to avoid rounding error in the
			 * comparison.
			 *
	 ...
	 * <code>Rectangle2D</code>.
	 * 
	 * @param l the specified {@link Line2D} to test for intersection with the
	 *          interior of this <code>Rectangle2D</code>
	 * @return <code>true</code> if the specified <code>Line2D</code> intersects the
	 *         interior of this <code>Rectangle2D</code>; <code>false</code>
	 *         otherwise.
	 * @since 1.2
	 */
	 ...
	 * <code>Rectangle2D</code>. This method computes a binary OR of the appropriate
	 * mask values indicating, for each side of this <code>Rectangle2D</code>,
	 * whether or not the specified coordinates are on the same side of the edge as
	 * the rest of this <code>Rectangle2D</code>.
	 * 
	 ...
	 * <code>Rectangle2D</code>. This method computes a binary OR of the appropriate
	 * mask values indicating, for each side of this <code>Rectangle2D</code>,
	 * whether or not the specified <code>Point2D</code> is on the same side of the
	 * edge as the rest of this <code>Rectangle2D</code>.
	 * 
	...
	/**
	 * Returns a new <code>Rectangle2D</code> object representing the intersection
	 * of this <code>Rectangle2D</code> with the specified <code>Rectangle2D</code>.
	 * 
	...
	/**
	 * Intersects the pair of specified source <code>Rectangle2D</code> objects and
	 * puts the result into the specified destination <code>Rectangle2D</code>
	 * object. One of the source rectangles can also be the destination to avoid
	 * creating a third Rectangle2D object, but in this case the original points of
	 * this source rectangle will be overwritten by this method.
	 * 
	 * @param src1 the first of a pair of <code>Rectangle2D</code> objects to be
	 *             intersected with each other
	 * @param src2 the second of a pair of <code>Rectangle2D</code> objects to be
	 *             intersected with each other
	 * @param dest the <code>Rectangle2D</code> that holds the results of the
	 ...
	 * result into the specified destination <code>Rectangle2D</code> object. One of
	 * the source rectangles can also be the destination to avoid creating a third
	 * Rectangle2D object, but in this case the original points of this source
	 ...
	 * @param src2 the second of a pair of <code>Rectangle2D</code> objects to be
	 *             combined with each other
	 * @param dest the <code>Rectangle2D</code> that holds the results of the union
	 *             of <code>src1</code> and <code>src2</code>
	 * @since 1.2
	 */
	...
	/**
	 * Adds a point, specified by the double precision arguments <code>newx</code>
	 * and <code>newy</code>, to this <code>Rectangle2D</code>. The resulting
	 * <code>Rectangle2D</code> is the smallest <code>Rectangle2D</code> that
	 * contains both the original <code>Rectangle2D</code> and the specified point.
	 * <p>
	 ...
	 * the right or bottom edges of a rectangle. Therefore, if the added point falls
	 * on the left or bottom edge of the enlarged rectangle, <code>contains</code>
	...
	/**
	 * Adds a <code>Rectangle2D</code> object to this <code>Rectangle2D</code>. The
	 * resulting <code>Rectangle2D</code> is the union of the two
	 ...
	 * <code>Rectangle2D</code>. The iterator for this class is multi-threaded safe,
	 * which means that this <code>Rectangle2D</code> class guarantees that
	 * modifications to the geometry of this <code>Rectangle2D</code> object do not
	 ...
	 *         outline of this <code>Rectangle2D</code>, one segment at a time.
	 * @since 1.2
	 */
	 ...
	 * <code>flatness</code> parameter is ignored. The iterator for this class is
	 * multi-threaded safe, which means that this <code>Rectangle2D</code> class
	 * guarantees that modifications to the geometry of this
	 * <code>Rectangle2D</code> object do not affect any iterations of that geometry
	 ...
	 * <code>Rectangle2D</code> if it is an instance of <code>Rectangle2D</code> and
	 * if its location and size are the same as this <code>Rectangle2D</code>.
	 * 
	 * @param obj an <code>Object</code> to be compared with this
	 *            <code>Rectangle2D</code>.
	 * @return <code>true</code> if <code>obj</code> is an instance of
	 *         <code>Rectangle2D</code> and has the same values; <code>false</code>
	 *         otherwise.
	 * @since 1.2
	 */
