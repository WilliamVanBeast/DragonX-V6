...
public abstract class Point2D implements Cloneable {
	...
	/**
	 * Sets the location of this <code>Point2D</code> to the same coordinates as the
	 * specified <code>Point2D</code> object.
	 * 
	 ...
	 *           <code>Point2D</code>
	 * @return the square of the distance between this <code>Point2D</code> and the
	 *         specified point.
	 * @since 1.2
	 */
