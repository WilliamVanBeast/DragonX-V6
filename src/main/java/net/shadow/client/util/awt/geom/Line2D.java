...
public abstract class Line2D implements Shape, Cloneable {
	 ...
	 * various accessory methods below.
	 *
	 ...
	 * <code>Line2D</code>. This method is required to implement the {@link Shape}
	 * interface, but in the case of <code>Line2D</code> objects it always returns
	 ...
	 * <code>Line2D</code> objects it always returns false since a line contains no
	 * area.
	 * 
	 ...
	 * <code>Shape</code> interface, but in the case of <code>Line2D</code> objects
